        ...
        <div className={styles['main']}>
            <div className="container">
                <div className={styles['content-section']}>
                    ...
                    <p>
                        During the early period of working for myself I was
                        using outsourced developers from many different
                        countries around the world to build my websites.
                    </p>
                    ...
                    <h3>
                        Life outside work - kids, dog, allotment, football,
