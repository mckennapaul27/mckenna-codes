    ...
    <section className={styles["main"]} id="projects">
      <div className="container">
        <div className={styles["content-section"]}>
          ...
          <p>
            I&apos;ve developed numerous projects over the years, some of which
            are shown here.
          </p>
          <p>
            My main source of income over the last decade has come from
            ewalletbooster.com which I originally created from an earlier
            project couponarbitrage.com. At it&apos;s peak, ewalletbooster.com
            was generating over $3m monthly affiliate sales volume for the
            affiliate networks I was working with.
          </p>
          <p>
            I have also developed a number of other projects including
            volumekings.com and fraffles.co.uk.
          </p>
          <p>
            And of course there are many projects that I have created over the
            years that have not worked out, the biggest being cashbackmad.co.uk
            which was hacked in 2015! I lost the entire site and database and it
            was the moment I decided I needed to learn to code and understand
            how to build secure and performant websites!
          </p>
        </div>
        ...
        <div className={styles["image_slider_section"]}>
          <div className={styles["image_wrapper"]}>
            <div className={styles["project_title_section"]}>
              <h3 className={classNames(styles["title"], montserrat.className)}>
                {project.title}
              </h3>
        ...
        <div className={styles["project_card_content_section"]}>
          ...
          <ul className={styles["tech-list"]}>
            {project.technologies.map((technology) => {
              return <li key={technology._id}>{technology.name}</li>;
            })}
          </ul>
          <p>
